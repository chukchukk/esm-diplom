...
public class NewRequestDelegate implements JavaDelegate {
	...
	public void execute(DelegateExecution delegateExecution) {
		...
		RequestData requestData = requestDataRepository
				.findById(requestId)
				.orElseThrow()
				.setStatus(RequestStatus.NEW)
				.setImplementer(null);
		RequestData updatedRequestData = requestDataRepository.save(requestData);
		approvalHistoryWriteService.writeApprovalHistoryWithComment(updatedRequestData, ApprovalHistoryActionType.STATUS_CHANGE);
	}
